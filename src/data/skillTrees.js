  ...
  warrior: {
    ...
    skills: [
      ...
      },
      {
        ...
        name: 'Warlord',
        emoji: '👑',
        description: 'While taunting, all allies deal 25% more damage. Party aura: +10% attack.',
        type: SKILL_TYPE.PASSIVE,
        tier: 3,
        passive: { type: 'taunt_party_bonus', damageBonus: 0.25 },
        partyBuff: { attackPercent: 0.10 },
      },
      {
  ...
  paladin: {
    ...
    skills: [
      // Tier 0 - Core
      {
        ...
        name: 'Divine Shield',
        emoji: '✨',
        description: 'Taunt enemies and reduce damage taken by 50% for 2 turns.',
        type: SKILL_TYPE.ACTIVE,
        tier: 0,
        starterSkill: true,
        cooldown: 5,
        targetType: TARGET_TYPE.SELF,
        effect: { type: EFFECT_TYPE.BUFF, damageReduction: 0.5, taunt: 2, duration: 2 },
      },
      {
  ...
  knight: {
    ...
    skills: [
      // Tier 0 - Core
      {
        ...
        name: 'Shield Bash',
        emoji: '🔨',
        description: 'Deal 200% damage and stun for 1 turn.',
        type: SKILL_TYPE.ACTIVE,
        tier: 0,
        starterSkill: true,
        cooldown: 4,
        targetType: TARGET_TYPE.SINGLE_ENEMY,
        effect: { type: EFFECT_TYPE.DAMAGE, multiplier: 2.0, stun: 1 },
      },
      {
        id: 'knight_heavy_armor',
        name: 'Heavy Armor',
        emoji: '🛡️',
        description: '+8 defense, +6 attack.',
        type: SKILL_TYPE.PASSIVE,
        tier: 0,
        passive: { type: 'stat_bonus', stats: { defense: 8, attack: 6 } },
      },
      {
      ...
      },
      {
        ...
        name: 'Fortress',
        emoji: '🏯',
        description: 'All damage to allies redirected to you at -50%. Party aura: +15% defense.',
        type: SKILL_TYPE.PASSIVE,
        tier: 3,
        passive: { type: 'redirect_damage', reduction: 50 },
        partyBuff: { defensePercent: 0.15 },
      },
      {
        id: 'knight_colossus',
        name: 'Colossus',
  ...
  cleric: {
    ...
    skills: [
      ...
      },
      {
        ...
        name: 'Radiance',
        emoji: '🌞',
        description: 'All heals also grant a shield equal to 30% of heal. Party aura: 2% HP regen/turn.',
        type: SKILL_TYPE.PASSIVE,
        tier: 3,
        passive: { type: 'heal_shield', percent: 30 },
        partyBuff: { regenPercent: 0.02 },
      },
    ],
  },
  ...
  shaman: {
    ...
    skills: [
      // Tier 0 - Core
      {
        ...
        name: 'Spirit Link',
        emoji: '🔗',
        description: 'Heal all 35% + buff attack 20% for 2 turns.',
        type: SKILL_TYPE.ACTIVE,
        tier: 0,
        starterSkill: true,
        cooldown: 5,
        targetType: TARGET_TYPE.ALL_ALLIES,
        effect: { type: EFFECT_TYPE.HEAL, percentOfMax: 0.35, attackBuff: 0.2, duration: 2 },
      },
      {
